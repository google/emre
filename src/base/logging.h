...
#ifndef BASE_LOGGING_H_  // NOLINT
#define BASE_LOGGING_H_

#include <assert.h>
#include <stdlib.h>
#include <iostream>
// #include "commandlineflags.h"  // NOLINT
#include "integral_types.h"  // NOLINT
#include "macros.h"  // NOLINT

#define FLAGS_log_level 0
//  DECLARE_int32(log_level);
#define FLAGS_log_prefix true
