...
#ifndef BASE_STRINGPIECE_H_  // NOLINT
...
bool operator==(const emre::StringPiece& x,
                const emre::StringPiece& y);

inline bool operator!=(const emre::StringPiece& x,
                       const emre::StringPiece& y) {
  return !(x == y);
}
...
extern std::ostream& operator<<(std::ostream& o,
                                const emre::StringPiece& piece);

#endif  // BASE_STRINGPIECE_H_  // NOLINT
